...
h = ROOT.TH1F("h","nuespec",30, 0.5, 8.0)
...
l1.AddEntry(h_beamnue, "Beam (#nu_{e} + #bar{#nu}_{e}) CC", "L")
l1.AddEntry(h_nutau, "(#nu_{#tau} + #bar{#nu}_{#tau}) CC", "L")
l1.AddEntry(h_numu, "(#nu_{#mu} + #bar{#nu}_{#mu}) CC", "L")
...
t1.Draw("same")
l1.Draw("same")
c1.SaveAs("plots/spec_app_nu.png")

hout = ROOT.TFile("root/spec_app_nu.root","RECREATE")
h.Write()
h_beamnue.Write()
h_numu.Write()
h_nutau.Write()
