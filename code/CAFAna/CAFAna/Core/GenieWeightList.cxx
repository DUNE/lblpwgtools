...
namespace ana
{
  ...
  std::vector<std::string> GetGenieWeightNames()
  {
	...
	"MvCCRES", "RDecBR1gamma", "RDecBR1eta", "NR_nu_n_CC_2Pi", 
	...
	"SPPLowQ2Suppression"
	// Stil a bit dodge: "E2p2h_A_nu","E2p2h_B_nu", "E2p2h_A_nubar", "E2p2h_B_nubar",
	...
	// "Theta_Delta2Npi", "CCQEPauliSupViaKF", "nuenuebar_xsec_ratio"
