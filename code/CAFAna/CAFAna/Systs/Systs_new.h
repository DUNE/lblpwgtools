...
namespace ana
{
  ...
  public:
    ...
    void Shift(double sigma,
               ...
               caf::StandardRecord* sr, double& weight) const override
    {
      if(sr->dune.isCC==1 && abs(sr->dune.neu)==14 && sr->dune.run==20000001) weight *= 1 + .05*sigma;
    }
  };
  ...
  public:
    ...
    void Shift(double sigma,
               ...
               caf::StandardRecord* sr, double& weight) const override
    {
      if(sr->dune.isCC==1 && abs(sr->dune.neu)==14 && sr->dune.run==20000004) weight *= 1 + .05*sigma;
    }
  };
  ...
  public:
    ...
    void Shift(double sigma,
               ...
               caf::StandardRecord* sr, double& weight) const override
    {
      if(sr->dune.isCC==1 && abs(sr->dune.neu)==12 && sr->dune.run==20000002) weight *= 1 + .02*sigma;
    }
  };
  ...
  public:
    ...
    void Shift(double sigma,
               ...
               caf::StandardRecord* sr, double& weight) const override
    {
      if(sr->dune.isCC==1 && abs(sr->dune.neu)==12 && sr->dune.run==20000005) weight *= 1 + .02*sigma;
    }
  };
  ...
  public:
    ...
    void Shift(double sigma,
               ...
               caf::StandardRecord* sr, double& weight) const override
    {
      if(sr->dune.isCC==0 && sr->dune.cvnnumu>0.5 && sr->dune.cvnnue<0.7) weight *= 1 + .1*sigma;
    }
  };
  ...
  public:
    ...
    void Shift(double sigma,
               ...
               caf::StandardRecord* sr, double& weight) const override
    {
      if((sr->dune.isCC==0 && sr->dune.cvnnumu<0.5 && sr->dune.cvnnue>0.7) || (sr->dune.isCC==1 && abs(sr->dune.neu)==14)) weight *= 1 + .05*sigma;
    }
  };
  ...
  public:
    ...
    void Shift(double sigma,
               ...
               caf::StandardRecord* sr, double& weight) const override
    {
      if(sr->dune.isCC==1 && abs(sr->dune.neu)==16) weight *= 1 + .2*sigma;
    }
  };
  ...
  public:
    ...
    void Shift(double sigma,
               ...
               caf::StandardRecord* sr, double& weight) const override
    {
      if(sr->dune.isCC==1 && abs(sr->dune.neu) == 12 && abs(sr->dune.beamPdg) == 12 && sr->dune.isFHC) weight *= 1 + .05*sigma;
    }
  };
