...
IExperiment* GetPenalty(int hie, int oct, std::string penalty, std::string asimov_set="0", bool modConstraint=false, bool useHugeOct=false){
  ...
  ret->SetHugeOctPenalty(useHugeOct);
  return ret;
}
