...
nuefile = "nuetest.root"
numufile = "numutest.root"
anuefile = "anuetest.root"
anumufile = "anumutest.root"
...
nue_POT = nue.Get("pottree")
numu_POT = numu.Get("pottree")
anue_POT = anue.Get("pottree")
anumu_POT = anumu.Get("pottree")
