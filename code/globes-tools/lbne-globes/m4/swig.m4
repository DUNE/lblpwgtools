...
dnl added some stuff to make missing work for SWIG, I consider SWIG as
dnl maintainer tool like bison. 
dnl Patrick Huber 2004
...
AC_REQUIRE([AM_MISSING_HAS_RUN])
 ...
 SWIG=${am_missing_run}swig

    dnl            SWIG='echo "Error: SWIG is not installed. You should look at http://www.swig.org" ; false'
        elif test -n "$1" ; then
