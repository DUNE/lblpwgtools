  ...
  if (first) {
    ...
    XSecSystDials = {
        ...
        {"MissingProtonFakeData", kUsedAsFakeData, kContinuous, kFakeDataRange,
         kOther},
	{"MissingProtonFakeDataNu", kUsedAsFakeData, kContinuous, kFakeDataRange,
         kOther},
	{"MissingProtonFakeDataNubar", kUsedAsFakeData, kContinuous, kFakeDataRange,
	 kOther},
	{"NuWroReweightFakeDataOld", kUsedAsFakeData, kContinuous, {-1,1},
         kOther},
