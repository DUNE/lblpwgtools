...
void gartkiuboone()
{
    ...
    TFile *fout = new TFile("gartkiuboone_nofsi.root","RECREATE");
    ...
    uBooNETKISelection tki_selection(muon_cut_low,
                                     muon_cut_hgh,
                                     prtn_cut_low,
                                     prtn_cut_hgh,
                                     pion_cut_hgh,
    ...
    const SRCut kSignalDefinitionCut = kIsTrueNuMuCC && kIsTrueContained(delta_l, delta_r) && tki_selection.kuBooNETKICut();
