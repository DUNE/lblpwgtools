...
class NuWroReweightFakeDataOldGenerator : public ana::ISyst {
public:

  virtual ~NuWroReweightFakeDataOldGenerator(){};
...
public:
  NuWroReweightFakeDataOldGenerator()
    : ana::ISyst("NuWroReweightFakeDataOldGenerator",
		 "NuWroReweightFakeDataOldGenerator", false, 0, 1){
