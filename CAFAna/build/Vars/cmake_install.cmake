# Install script for directory: /exp/dune/app/users/gyang/lblpwgtools/CAFAna/Vars
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/exp/dune/app/users/gyang/lblpwgtools/CAFAna/build/Vars/libCAFAnaVars.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libCAFAnaVars.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libCAFAnaVars.so")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/CAFAna/Vars" TYPE FILE FILES
    "/exp/dune/app/users/gyang/lblpwgtools/CAFAna/Vars/DUNENeutNuWROReweight.h"
    "/exp/dune/app/users/gyang/lblpwgtools/CAFAna/Vars/FitVars.h"
    )
endif()
