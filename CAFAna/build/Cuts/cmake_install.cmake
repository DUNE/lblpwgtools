# Install script for directory: /exp/dune/app/users/gyang/lblpwgtools/CAFAna/Cuts
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  ...
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/lib" TYPE SHARED_LIBRARY FILES "/exp/dune/app/users/gyang/lblpwgtools/CAFAna/build/Cuts/libCAFAnaCuts.so")
  if(EXISTS "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libCAFAnaCuts.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}${CMAKE_INSTALL_PREFIX}/lib/libCAFAnaCuts.so")
...
if("x${CMAKE_INSTALL_COMPONENT}x" STREQUAL "xUnspecifiedx" OR NOT CMAKE_INSTALL_COMPONENT)
  file(INSTALL DESTINATION "${CMAKE_INSTALL_PREFIX}/include/CAFAna/Cuts" TYPE FILE FILES
    "/exp/dune/app/users/gyang/lblpwgtools/CAFAna/Cuts/AnaCuts.h"
    "/exp/dune/app/users/gyang/lblpwgtools/CAFAna/Cuts/TruthCuts.h"
    )
endif()
