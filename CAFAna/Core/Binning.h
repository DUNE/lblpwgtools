...
namespace ana
{
  ...
  /*const std::vector<double> kHadBinEdges = {0., 0.05, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35,
                                            0.4, 0.45, 0.5, 0.6, 0.7, 0.8, 0.9, 1.,
                                            1.5, 2., 20.};
  const std::vector<double> kLepBinEdges = {0., 0.5, 0.625, 0.75, 0.875, 1., 1.125, 1.25, 
                                            1.375, 1.5, 1.625, 1.75, 1.875, 2., 2.125, 2.25,
                                            2.375, 2.5, 2.625, 2.75, 2.875, 3., 3.25, 3.5, 4., 20};*/
