...
PredictionNoOsc::PredictionNoOsc(SpectrumLoaderBase &loader,
    ...
    : fSpectrum(loader, axis, cut, shift, wei),
      ...
      fSpectrumNumu(loader, axis, cut && !kIsNC && kIsNumuCC && !kIsAntiNu,
                    shift, wei),
      fSpectrumNumubar(loader, axis, cut && !kIsNC && kIsNumuCC && kIsAntiNu,
                       shift, wei),
      fSpectrumNue(loader, axis, cut && !kIsNC && kIsBeamNue && !kIsAntiNu,
                   shift, wei),
      fSpectrumNuebar(loader, axis, cut && !kIsNC && kIsBeamNue && kIsAntiNu,
                      shift, wei) {}
