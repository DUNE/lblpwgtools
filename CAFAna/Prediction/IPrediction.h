...
public:
  ...
  virtual void Derivative(
      osc::IOscCalculator *calc, const SystShifts &shift, double pot,
  ...
  virtual OscillatableSpectrum ComponentCC(int from, int to) const {
    std::cout << "OscillatableSpectrum::ComponentCC() unimplemented"
              << std::endl;
    abort();
  }
  virtual Spectrum ComponentNC() const {
    std::cout << "OscillatableSpectrum::ComponentNC() unimplemented"
              << std::endl;
    abort();
  }
