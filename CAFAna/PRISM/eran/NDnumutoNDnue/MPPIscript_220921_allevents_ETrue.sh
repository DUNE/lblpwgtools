...
# if want only few events, add -n 1000 to the command and ALSO set CAFND_FHC AND RHC !!_35Yr="CAFv7_*subset00.root" also maybe search in that directory for just one single file to make it go even faster? 
...
MakePRISMPredInterps -o /dune/data/users/erea/PRISMPredInterps/NDnumutoNDnue_220921_allevents_ETrue.root \
    ...
    -A ETrue --PRISM-fake-data ${FakeData} --UseSelection 
