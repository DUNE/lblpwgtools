...
namespace ana {
  ...
  REGISTER_LOADFROM("PredictionNonSwapNoExtrap", IPrediction, PredictionNonSwapNoExtrap);
  //----------------------------------------------------------------------
  ...
  REGISTER_LOADFROM("DataPredictionNoExtrap", IPrediction, DataPredictionNoExtrap);
  //----------------------------------------------------------------------
  ...
  REGISTER_LOADFROM("PredictionFDNoOsc", IPrediction, PredictionFDNoOsc);
  //----------------------------------------------------------------------
