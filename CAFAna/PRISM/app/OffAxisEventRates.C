...
std::string const &off_axis_file = pred.get<std::string>("input_file");
  ...
  Spectrum NDSpect_signal_AnaWeighted(NDLoader, axes.XProjection, axes.OffAxisPosition,
  ...
  Spectrum NDSpect_signal_CVXSecWeighted(NDLoader, axes.XProjection,
                                  ...
                                  NDWeight_XSec);
  Spectrum NDSpect_signal_EffWeighted(NDLoader, axes.XProjection, axes.OffAxisPosition,
                               NDSignalCut, kNoShift, NDWeight_Eff);
  Spectrum NDSpect_signal_AllWeighted(NDLoader, axes.XProjection, axes.OffAxisPosition,
  ...
  Spectrum NDSpect_select_AnaWeighted(NDLoader, axes.XProjection,
                                      ...
                                      kNoShift, NDWeight);
  Spectrum NDSpect_select_AnaWeighted_Sig(NDLoader, axes.XProjection,
                                      axes.OffAxisPosition, NDSignalCut_sel_signal,
                                      kNoShift, NDWeight);
  Spectrum NDSpect_select_AnaWeighted_WSB(NDLoader, axes.XProjection,
                                      axes.OffAxisPosition, NDSignalCut_sel_WSB,
                                      kNoShift, NDWeight);
  Spectrum NDSpect_select_AnaWeighted_NC(NDLoader, axes.XProjection,
                                      axes.OffAxisPosition, NDSignalCut_sel_NC,
                                      kNoShift, NDWeight);
  Spectrum NDSpect_select_CVXSecWeighted(NDLoader, axes.XProjection,
                                  axes.OffAxisPosition, NDSignalCut_sel, kNoShift,
                                  NDWeight_XSec);
  Spectrum NDSpect_select_CVXSecWeighted_Sig(NDLoader, axes.XProjection,
                                      axes.OffAxisPosition, NDSignalCut_sel_signal,
                                      kNoShift, NDWeight_XSec);
  Spectrum NDSpect_select_CVXSecWeighted_WSB(NDLoader, axes.XProjection,
                                      axes.OffAxisPosition, NDSignalCut_sel_WSB,
                                      kNoShift, NDWeight_XSec);
  Spectrum NDSpect_select_CVXSecWeighted_NC(NDLoader, axes.XProjection,
                                      axes.OffAxisPosition, NDSignalCut_sel_NC,
                                      kNoShift, NDWeight_XSec);
  ...
  NearDet_signal_AnaWeighted->SetTitle(";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_signal_AnaWeighted, "NearDet_signal_AnaWeighted");

  TH1 *NearDet_signal_CVXSecWeighted = NDSpect_signal_CVXSecWeighted.ToTHX(POT120);
  NearDet_signal_CVXSecWeighted->SetTitle(
      ";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_signal_CVXSecWeighted, "NearDet_signal_CVXSecWeighted");

  TH1 *NearDet_signal_EffWeighted = NDSpect_signal_EffWeighted.ToTHX(POT120);
  NearDet_signal_EffWeighted->SetTitle(";EProxy (GeV);OffAxis Position (m);ND EvRate");
  ...
  NearDet_signal_AllWeighted->SetTitle(";EProxy (GeV);OffAxis Position (m);ND EvRate");
  ...
  NearDet_select_AnaWeighted->SetTitle(";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_select_AnaWeighted, "NearDet_select_AnaWeighted");

  TH1 *NearDet_select_AnaWeighted_Sig = NDSpect_select_AnaWeighted_Sig.ToTHX(POT120);
  NearDet_select_AnaWeighted_Sig->SetTitle(";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_select_AnaWeighted_Sig, "NearDet_select_AnaWeighted_Sig");

  TH1 *NearDet_select_AnaWeighted_WSB = NDSpect_select_AnaWeighted_WSB.ToTHX(POT120);
  NearDet_select_AnaWeighted_WSB->SetTitle(";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_select_AnaWeighted_WSB, "NearDet_select_AnaWeighted_WSB");

  TH1 *NearDet_select_AnaWeighted_NC = NDSpect_select_AnaWeighted_NC.ToTHX(POT120);
  NearDet_select_AnaWeighted_NC->SetTitle(";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_select_AnaWeighted_NC, "NearDet_select_AnaWeighted_NC");

  TH1 *NearDet_select_CVXSecWeighted = NDSpect_select_CVXSecWeighted.ToTHX(POT120);
  NearDet_select_CVXSecWeighted->SetTitle(
      ";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_select_CVXSecWeighted, "NearDet_select_CVXSecWeighted");

  TH1 *NearDet_select_CVXSecWeighted_Sig = NDSpect_select_CVXSecWeighted_Sig.ToTHX(POT120);
  NearDet_select_CVXSecWeighted_Sig->SetTitle(
      ";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_select_CVXSecWeighted_Sig, "NearDet_select_CVXSecWeighted_Sig");

  TH1 *NearDet_select_CVXSecWeighted_WSB = NDSpect_select_CVXSecWeighted_WSB.ToTHX(POT120);
  NearDet_select_CVXSecWeighted_WSB->SetTitle(
      ";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_select_CVXSecWeighted_WSB, "NearDet_select_CVXSecWeighted_WSB");
  ...
  NearDet_select_CVXSecWeighted_NC->SetTitle(
      ";EProxy (GeV);OffAxis Position (m);ND EvRate");
  f.WriteTObject(NearDet_select_CVXSecWeighted_NC, "NearDet_select_CVXSecWeighted_NC");
