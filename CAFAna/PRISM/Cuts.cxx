...
const ana::Cut kPRISMNDSignal_Selected_nue =
    ana::kPassND_FHC_NUE && ana::kIsTrueFV && kIsOutOfTheDesert;
const ana::Cut kPRISMNDSignal_Selected_nueb =
    ana::kPassND_RHC_NUE && ana::kIsTrueFV && kIsOutOfTheDesert;
const ana::Cut kPRISMNDSignal_True_nue =
    ana::kIsBeamNue && (!ana::kIsAntiNu) && ana::kIsTrueFV && kIsOutOfTheDesert;
const ana::Cut kPRISMNDSignal_True_nueb =
    ana::kIsBeamNue && (ana::kIsAntiNu) && ana::kIsTrueFV && kIsOutOfTheDesert;
