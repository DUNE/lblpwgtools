...
static EffectiveFluxUncertaintyHelper *globalFluxHelper = nullptr;
EffectiveFluxUncertaintyHelper const &EffectiveFluxUncertaintyHelper::Get() {
  if (!globalFluxHelper) {
...
void EffectiveFluxUncertaintyHelper::Initialize(std::string const &filename) {
...
int EffectiveFluxUncertaintyHelper::GetMatrixBin(int nu_config, double enu_GeV,
                                                 double off_axis_pos_m) {
