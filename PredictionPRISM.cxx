...
PredictionPRISM::PredictPRISMComponents(osc::IOscCalc *calc, SystShifts shift,
  ...
  // Test filtering out ND/FD detector systs for ND/FD predictions
  //std::vector<ana::ISyst const *> NDsystlist = FilterOutNDSysts(shift.ActiveSysts());
  
  //SystShifts NDshift(NDsystlist);
