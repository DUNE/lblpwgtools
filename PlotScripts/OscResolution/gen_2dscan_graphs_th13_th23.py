...
if __name__=="__main__":
	tr_ssth23_vals = [0.58,0.58,0.42, 0.42, 0.58,0.58, 0.42]
	tr_th13_vals = [0.126855,0.126855,0.150590,0.150590,0.150590,0.150590,0.171415]
	...
	for i in range(len(tr_ssth23_vals)):
		...
		for j in range(100):
			tf = ROOT.TFile("/pnfs/dune/persistent/users/jfleishh/2D_th13_th23_scan_hres_grid/%s/asimov_th13-ssth23_ndfd1000_allsyst_nopen_th13:%lf,ssth23:%lf_hie1_nominal_%03d.root" % (names[i], tr_th13_vals[i], tr_ssth23_vals[i], j))
