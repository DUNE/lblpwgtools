...
if __name__=="__main__":
	...
	for ssth23 in ssth23_vals:
		can = ROOT.TCanvas()
		h = ROOT.TH2D()
		h.SetTitle(";True sin^{2}2#theta_{13};Allowed sin^{2}2#theta_{13}")
		h.GetXaxis().SetLimits(0.063,0.113)
		h.GetYaxis().SetLimits(0.04, 0.14)
		h.Draw()
		leg = ROOT.TLegend(0.1,0.9,0.9,1.0)
		leg.SetNColumns(3)
		for i in range(len(level_names)):
			gf = ROOT.TFile("1dscan_graphs/ss2th13_1000/allwdreg_bandfull_graphs_ssth23=%lf_%s.root" % (ssth23,level_names[i]))
			for pos in graph_pos:
				...
				g.Draw("F SAME")
		leg.Draw()
		can.Print("allwdreg_plots/ss2th13_1000/allwdreg_bandfull_plot_ssth23=%lf.png" % ssth23)
		can.Print("allwdreg_plots/ss2th13_1000/allwdreg_bandfull_plot_ssth23=%lf.pdf" % ssth23)
