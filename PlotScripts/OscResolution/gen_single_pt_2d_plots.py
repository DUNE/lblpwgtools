...
if __name__=="__main__":
	hFile = ROOT.TFile("single_pt_hists/2ParamPFHists_ndfd1000_ss2th13=0.088_dmsq32=2.45_ssth23=0.54_dcp=-0.25.root")
	...
	for name in hNames:
		...
		h = hFile.Get(name)
		h.Draw("colz")
		can.Print("2ParamPFPlots_ndfd1000_ss2th13=0.088_dmsq32=2.45_ssth23=0.54_dcp=-0.25/%s.png"%name)
	print "Plots Printed"
