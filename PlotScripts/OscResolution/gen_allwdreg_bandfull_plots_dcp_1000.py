...
if __name__=="__main__":
	...
	for ssth23 in ssth23_vals:
		...
		for i in range(len(level_names)):
			gf = ROOT.TFile("1dscan_graphs/dcp_1000/allwdreg_bandfull_graphs_ssth23=%lf_%s.root" % (ssth23,level_names[i]))
		...
		leg.Draw()
		can.Print("allwdreg_plots/dcp_1000/allwdreg_bandfull_plot_ssth23=%lf.png" % ssth23)
		can.Print("allwdreg_plots/dcp_1000/allwdreg_bandfull_plot_ssth23=%lf.pdf" % ssth23)
