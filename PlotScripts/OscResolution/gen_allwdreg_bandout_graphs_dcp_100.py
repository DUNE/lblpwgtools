...
if __name__=="__main__":
	...
	for n in range(len(targ_dchisqs)):
		for i in range(len(ssth23_vals)):
			...
			tf = ROOT.TFile("1dscan_graphs/dcp_100/1dscan_graphs_ssth23=%lf.root" % ssth23_vals[i])
		...
		#		graphs[j].SetTitle(";True #delta_{cp};Allowed #delta_{cp}")	
			...
			outf = ROOT.TFile("1dscan_graphs/dcp_100/allwdreg_bandout_graphs_ssth23=%lf_%s.root" % (ssth23_vals[i],level_names[n]), "RECREATE")
