...
if __name__=="__main__":
	f = ROOT.TFile("single_pt_hists/2ParamPFCLs_ndfd1000_ss2th13=0.088_dmsq32=2.45_ssth23=0.54_dcp=-0.25.root", "RECREATE")
	f.Close()
	...
	for i in range(len(hNames)):
		print "Loop Started"
		hf = ROOT.TFile("single_pt_hists/2ParamPFHists_ndfd1000_ss2th13=0.088_dmsq32=2.45_ssth23=0.54_dcp=-0.25.root")
		print "Passed 1"
		...
		outf = ROOT.TFile("single_pt_hists/2ParamPFCLs_ndfd1000_ss2th13=0.088_dmsq32=2.45_ssth23=0.54_dcp=-0.25.root", "UPDATE")
		hCL.Write()
		outf.Close()
		hf.Close()
		print "LOOP END"
