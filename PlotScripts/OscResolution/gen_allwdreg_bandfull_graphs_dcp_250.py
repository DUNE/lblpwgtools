...
if __name__=="__main__":
	...
	for ssth23 in ssth23_vals:
		for i in range(len(level_names)):
			bands = []
			gf = ROOT.TFile("1dscan_graphs/dcp_250/allwdreg_bandout_graphs_ssth23=%lf_%s.root" % (ssth23,level_names[i]))
			...
			outf = ROOT.TFile("1dscan_graphs/dcp_250/allwdreg_bandfull_graphs_ssth23=%lf_%s.root" % (ssth23, level_names[i]), "RECREATE")
			band_mg.Write()
			#lband.Write()
			#mband.Write()
			#uband.Write()
