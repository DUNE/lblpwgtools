...
if __name__=="__main__":
	...
	for i in range(len(ssth23_vals)):
		...
		for j in range(len(tr_dcp_vals)):
			...
			tf = ROOT.TFile("/pnfs/dune/persistent/physicsgroups/dunelbl/picker24/contrib/jfleishh/dcp_1dscan_1000/asimov_deltapi_ndfd1000_allsyst_nopen_ssth23:%lf,deltapi:%lf_hie1_nominal.root" % (ssth23_vals[i], tr_dcp_vals[j]))
		...
		outf = ROOT.TFile("1dscan_graphs/dcp_1000/1dscan_graphs_ssth23=%lf.root"%ssth23_vals[i], "RECREATE")
		for g in scanGs:
			g.Write()
