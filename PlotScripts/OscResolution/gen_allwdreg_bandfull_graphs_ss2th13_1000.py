...
if __name__=="__main__":
	...
	for ssth23 in ssth23_vals:
		for i in range(len(level_names)):
			gf = ROOT.TFile("1dscan_graphs/ss2th13_1000/allwdreg_bandout_graphs_ssth23=%lf_%s.root" % (ssth23,level_names[i]))
			lband = ROOT.TGraph()
			...
			outf = ROOT.TFile("1dscan_graphs/ss2th13_1000/allwdreg_bandfull_graphs_ssth23=%lf_%s.root" % (ssth23, level_names[i]), "RECREATE")
			lband.Write()
			uband.Write()
	print "---END---"
